...
This repository contains code and pretrained models for the brain age prediction pipeline used in our study, published in *Computers in Biology and Medicine* (2025). We used machine learning (Support Vector Regression, Deep Kernel Learning Gaussian Process Regression [DKL-GPR], and BrainAgeR) to estimate brain age from structural MRI features and analyze brain-predicted age difference (brain-PAD) in participants with anorexia nervosa (AN) and healthy controls (HC).
